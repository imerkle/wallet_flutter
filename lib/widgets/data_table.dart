...
class MyDataTable extends StatelessWidget {
  ...
  /// {@template flutter.material.MyDataTable.showCheckboxColumn}
  ...
  Widget build(BuildContext context) {
    ...
    //final bool displayCheckboxColumn = showCheckboxColumn && rows.any((MyDataRow row) => row.onSelectChanged != null);
    //final bool allChecked = displayCheckboxColumn && !rows.any((MyDataRow row) => row.onSelectChanged != null && !row.selected);
    final bool displayCheckboxColumn = false;
    ...
    for (int MyDataColumnIndex = 0;
      ...
      double paddingStart;
      if (MyDataColumnIndex == 0 && displayCheckboxColumn) {
        paddingStart = horizontalMargin / 2.0;
      } else if (MyDataColumnIndex == 0 && !displayCheckboxColumn) {
